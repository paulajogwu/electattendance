...
function sampleAcquired(s){   
            ...
            // Get samples from the object - get 0th element of samples as base 64 encoded PNG image         
                ...
                var fingerPrint = JSON.stringify(samples[0]); 
                var course = document.getElementById('course').value
                var date = document.getElementById('date').value
                var data ={fingerPrint,course,date}
                var store = localStorage.setItem("imageSrc", "data:image/png;base64," + Fingerprint.b64UrlTo64(samples[0]));
                ...
                console.log('Fingerprint',decodedData.Data)
                localStorage.setItem("raw", "data:image/png;base64," + Fingerprint.b64UrlTo64(decodedData.Data));
