...
function sampleAcquired(s){   
            ...
            // Get samples from the object - get 0th element of samples as base 64 encoded PNG image         
                ...
                axios({ url: `http://localhost:8070/finger`,
                method: 'post',
                 data })
                ...
                // xhre.open("POST", 'http://localhost:8070/find/'+ `${foldercode}`);
        
                // xhre.onreadystatechange = function () {
                //     if (this.status == 200 && this.readyState == 4) {
                //         let apiDatae = JSON.parse(this.responseText);
        
                //         let title = apiDatae.refnumber;
                //         document.getElementById('refnumber').value = title;
